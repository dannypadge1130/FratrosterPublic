    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-12 text-center">          
          ...
          <p class="help-block">How about crossing that finish line?</p>  
          <hr>
        </div>
      ...
      <div class="row">         
        <div class="col-lg-4 col-lg-offset-4 col-md-5 col-md-offset-4 col-sm-6 col-sm-offset-3">          
          ...
          <!--College Email-->
          <g:form role="form" id="create-profile-form" name="create-profile-form" action="emailValidation_save" useToken="true">            
          ...
          <g:if test="${userInstance?.verificationPin != null && !userInstance?.verificationPin.isEmpty()}">      
            <!--Validate Edu Email-->
            <g:form role="form" id="verify-pin-form" name="verify-pin-form" action="eduPinValidation" useToken="true">            
              <div class="form-group">
      ...
      <!--Finish Your Profile Breadcrumbs-->
