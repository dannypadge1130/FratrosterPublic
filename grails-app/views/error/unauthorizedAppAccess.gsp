...
<html lang="en">
	<head>
    	...
    	<meta name="description" content="Fraternity App Access Error">
        	...
        	<div class="row">
          		<div class="col-lg-6 col-lg-offset-3">
            		...
            		<div class="banner">
              		...
              		<p class="text-center">You do not currently have access to this Application. Please Contact the Fraternity Admin for access. Thank you.</p>
              		</div>
              	</div>
             </div>
